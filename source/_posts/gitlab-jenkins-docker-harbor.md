---
title: gitlab+jenkins+docker+harbor实现流程自动化
author: 张大哥
top: false
cover: false
toc: true
...
>
> ![image-20200512165810293]( image-20200512165810293.png)
>
> **2、容器镜像仓库**	
>
> ​	ip: 		 
...
![image-20200509173109582]( image-20200509173109582.png)

![image-20200509172959892]( image-20200509172959892.png)

创建仓库

![image-20200509173218474]( image-20200509173218474.png)

![image-20200509173227261]( image-20200509173227261.png)

创建账户

![image-20200509173242826]( image-20200509173242826.png)

![image-20200509173250977]( image-20200509173250977.png)

项目授权

![image-20200509173311987]( image-20200509173311987.png)

![image-20200509173319302]( image-20200509173319302.png)
...
![image-20200509174138114]( image-20200509174138114.png)
...
![image-20200512101026784]( image-20200512101026784.png)

![image-20200512101109339]( image-20200512101109339.png)

![image-20200512101120858]( image-20200512101120858.png)

![image-20200512101145738]( image-20200512101145738.png)

点击“系统管理”，“系统配置”，找到“SSH remote hosts”。

![image-20200512101210294]( image-20200512101210294.png)
...
![image-20200512101348331]( image-20200512101348331.png)

Goals and options填写：clean package -Dmaven.test.skip=true

![image-20200512101411044]( image-20200512101411044.png)

### 2、配置Post Steps

注：脚本中用到的仓库和认证的账号需要先在harbor新建好。

![image-20200512101638389]( image-20200512101638389.png)
...
![image-20200512101901486]( image-20200512101901486.png)

![image-20200512101918476]( image-20200512101918476.png)
...
![image-20200512102013778]( image-20200512102013778.png)
